...
#------------------------------------------------------------------------------
# Certificate Upload - Production Environment
#------------------------------------------------------------------------------
# Uploads Cloudflare certificate to the prod Container App Environment.
...
RESOURCE_GROUP="${RESOURCE_GROUP:-rg-finrisk-prod}"
ENVIRONMENT_NAME="${ENVIRONMENT_NAME:-cae-finrisk-prod}"
DOMAIN_NAME="${DOMAIN_NAME:-finrisk.pangarabbit.com}"

echo -e "${BLUE}════════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}        Certificate Upload - Production Environment             ${NC}"
echo -e "${BLUE}════════════════════════════════════════════════════════════════${NC}"
echo ""
...
if ! az containerapp env show \
    ...
    echo -e "  cd terraform/environments/prod"
...
echo -e "   ${YELLOW}cd terraform/environments/prod${NC}"
